      ...
      <div>
        <ul id="navbar">
          ...
          <li><a href="contact.jsp">Contact</a></li>
			<li><a class="active"  href="user.jsp">Login</a></li>
				...
				<div class="sign-in-htm">
					...
					<div class="group">
						<label for="email" class="label">Email Address</label> <input
							id="email" type="text" class="input" name="login-email">
						<div class="group">
							<label for="pass" class="label">Password</label> <input id="pass"
								type="password" class="input" data-type="password" name="login-password">
						</div>
						<div class="group">
				...
				<form action="regi.jsp" method="post">
					...
					<div class="group">
						<label for="user" class="label">Full Name</label> <input id="user"
							type="text" class="input" name="regi-name">
					</div>
					<div class="group">
						<label for="pass" class="label">Email Address</label> <input
							id="pass" type="text" class="input" name="regi-email">
					</div>
					<div class="group">
						<label for="pass" class="label">Password</label> <input id="pass"
							type="password" class="input" data-type="password" name="regi-pass">
					</div>

					<div class="group">
						<input type="submit" class="button" value="Sign Up" onclick="myFunction()">
					</div>
					<div class="hr"></div>
					<div class="foot-lnk">
