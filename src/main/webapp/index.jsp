...
<body>
  ...
  <!-- Hero -->
    ...
    <section id="product1" class="section-p1">
      ...
      <div class="pro-container">
        ...
        <a href="#" onclick="myFunction()">
          <img src="img/urbanic_img/tshirt/floral/floral_dress_1.jpg" alt="" /></a>
          <div class="des">
            <span>Urbanic</span>
     ...
     <i class="fa fa-shopping-cart cart"></i></a>
        ...
        <div class="pro">
        <a href="#" onclick="myFunction()">
          <img src="img/urbanic_img/tshirt/floral/floral_dress_2.jpg" alt="" /></a>
          <div class="des">
            <span>Urbanic</span>
        ...
        <div class="pro">
        <a href="#" onclick="myFunction()">
          <img src="img/urbanic_img/tshirt/floral/floral_dress_3.jpg" alt="" /></a>
          <div class="des">
            <span>Urbanic</span>
        ...
        <div class="pro">
        <a href="#" onclick="myFunction()">
         <img src="img/urbanic_img/tshirt/floral/floral_dress_4.jpg" alt="" /></a>
          <div class="des">
            <span>Urbanic</span>
        ...
        <div class="pro">
        <a href="#" onclick="myFunction()">
          <img src="img/urbanic_img/kurtis/k1.jpg" alt="" /></a>
          <div class="des">
            <span>Lavie</span>
            <h5>Floral Kurtis</h5>
            <div class="star">
        ...
        <div class="pro">
        <a href="#" onclick="myFunction()">
          <img src="img/urbanic_img/dangri/da1.jpg" alt="" /></a>
          <div class="des">
            <span>Lavie</span>
            <h5>Jump Suit</h5>
            <div class="star">
        ...
        <div class="pro">
        <a href="#" onclick="myFunction()">
          <img src="img/urbanic_img/kurtis/ku3.jpg" alt="" /></a>
        ...
        <div class="pro">
        <a href="#" onclick="myFunction()">
          <img src="img/urbanic_img/shoulder Top/s2.jpg" alt="" /></a>
          <div class="des">
            <span>Lavie</span>
            <h5>Fancy Shoulder Top</h5>
            <div class="star">
              <i class="far fa-star"></i>
              <i class="far fa-star"></i>
              <i class="far fa-star"></i>
    ...
    <section id="product1" class="section-p1">
      ...
      <div class="pro-container">
        <div class="pro">
          <img src="img/urbanic_img/tshirt/no_model_1.jpg" >
          <div class="des">
            <span>MANGO</span>
    ...
    <section id="sm-banner" class="section-p1">
      <div class="banner-box banner-box-1">
        ...
        <button class="white" onclick="location.href='shop.jsp';">Learn more</button>
      </div>
      <div class="banner-box banner-box-2">
        <h4>spring/summer</h4>
        <h2>upcoming season</h2>
        <span>The best class dress is on sale at cara</span>
        <button class="white" onclick="location.href='shop.jsp';">Collection</button>
      </div>
    </section>
